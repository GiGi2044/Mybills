class BillsController < ApplicationController
  ...
  #   contact_details = "#{current_user.fullname}, +41792333772, #{current_user.email}"
  ...
  def pdf
    @bill = Bill.find(params[:id])
    pdf = generate_pdf(@bill, current_user)
    send_data(pdf.render, filename: "bill.pdf", type: "application/pdf", disposition: "inline")
  end
